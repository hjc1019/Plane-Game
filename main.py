...
pygame.display.set_caption("hjc的飞机大战")
        ...
        if not paused and life_num:
            ...
            if not(delay % 10):
                ...
                if weapon_level == 5:
                    ...
                    bullets[bullet5_index + 1].reset((me.rect.centerx - 33, me.rect.centery))
                    bullets[bullet5_index + 2].reset((me.rect.centerx + 30, me.rect.centery))
                    bullet5_index = (bullet5_index + 3) % BULLET5_NUM
                if weapon_level == 6:
                    bullets = bullet6
                    bullets[bullet6_index].reset(me.rect.midtop)
                    bullets[bullet6_index + 1].reset((me.rect.centerx - 33, me.rect.centery))
                    bullets[bullet6_index + 2].reset((me.rect.centerx + 30, me.rect.centery))
